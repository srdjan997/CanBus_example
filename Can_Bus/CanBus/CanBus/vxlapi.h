...
|
|-----------------------------------------------------------------------------
| $Author: visges $    $Date: 2019-02-26 08:31:40 +0100 (Di, 26 Feb 2019) $   $Revision: 99864 $
| $Id: vxlapi.h 99864 2019-02-26 07:31:40Z visges $
|-----------------------------------------------------------------------------
...
#define XL_BUS_TYPE_KLINE           0x00000800
...
#define XL_TRANSCEIVER_TYPE_ETH_DP83XG710Q1_FIX     0x0235 //!< Onboard TI 1000BASE-T1 Eth PHY
...
#define XL_TRANSCEIVER_TYPE_ETH_MOD_BR_SGMII_DP83XG710Q1 0x0305 //!< 1Gbit (1000BASE-T1) SGMII Module with 2x TI DP83GX710-Q1
...
#define XL_ERR_FR_CLUSTERCONFIG_MISSING             0x0105    // No cluster configuration has been sent to the driver but is needed for the command which failed
#define XL_ERR_PDU_OFFSET_REPET_INVALID             0x0106    // Invalid offset and/or repetition value specified
#define XL_ERR_PDU_PAYLOAD_SIZE_INVALID             0x0107    // Specified PDU payload size is invalid (e.g. size is too large) Frame-API: size is different than static payload length configured in cluster config
...
#define XL_ERR_FR_SLOT_ALREADY_OCCUPIED_BY_ERAY     0x010C    // Specified slot cannot be used by Coldstart-Controller because it's already in use by the eRay
#define XL_ERR_FR_SLOT_ALREADY_OCCUPIED_BY_COLDC    0x010D    // Specified slot cannot be used by eRay because it's already in use by the Coldstart-Controller
...
#define XL_ERR_FR_SLOT_IN_WRONG_SEGMENT             0x010F    // Specified slot is not in correct segment. E.g.: A dynamic slot was specified for startup&sync
#define XL_ERR_FR_FRAME_CYCLE_MULTIPLEX_ERROR       0x0110    // The given frame-multiplexing rule (specified by offset and repetition) cannot be done because some of the slots are already in use
...
#define XL_HWTYPE_VN5640                        89
#define XL_HWTYPE_VX0312                        91
#define XL_HWTYPE_VH6501                        94
...
#define XL_HWTYPE_VX1135                        104
#define XL_HWTYPE_VN4610                        105
#define XL_HWTYPE_VT6306                        107
#define XL_HWTYPE_VT6104A                       108
#define XL_HWTYPE_VN5430                        109
#define XL_HWTYPE_VN1530                        112
#define XL_HWTYPE_VN1531                        113

#define XL_MAX_HWTYPE                           113
...
typedef void *HANDLE;  // HARD CORE SB
...
#define XL_CHANNEL_FLAG_CMACTLICENSE_SUPPORT     0x40000000
...
typedef struct s_xl_most_stream_buffer {
  unsigned int   streamHandle;
#ifdef _MSC_VER
  unsigned char *__ptr32 pBuffer; // 32bit LSDW of buffer pointer     // HARD CORE SB (POINTER_32)
#else
...
////////////////////////////////////////////////////////////////
// K-Line event tags
#define XL_KLINE_EVT_RX_DATA                1
#define XL_KLINE_EVT_TX_DATA                2

#define XL_KLINE_EVT_TESTER_5BD             3
#define XL_KLINE_EVT_ECU_5BD                5

#define XL_KLINE_EVT_TESTER_FI_WU_PATTERN   7
#define XL_KLINE_EVT_ECU_FI_WU_PATTERN      8
#define XL_KLINE_EVT_ERROR                  9

#define XL_KLINE_EVT_CONFIRMATION          10
...
// defines for xlKlineSetUartParams 
// parity values
#define XL_KLINE_UART_PARITY_NONE               0
#define XL_KLINE_UART_PARITY_EVEN               1
#define XL_KLINE_UART_PARITY_ODD                2
#define XL_KLINE_UART_PARITY_MARK               3
#define XL_KLINE_UART_PARITY_SPACE              4

////////////////////////////////////////
// defines for xlKlineSwitchHighspeedMode 
// trxMode values
#define XL_KLINE_TRXMODE_NORMAL                 0
#define XL_KLINE_TRXMODE_HIGHSPEED              1

////////////////////////////////////////
// defines for xlKlineSwitchTesterResistor
// tester values
#define XL_KLINE_TESTERRESISTOR_OFF             0
#define XL_KLINE_TESTERRESISTOR_ON              1

////////////////////////////////////////
// defines for xlKlineInit5BdEcu
// configure values
#define XL_KLINE_UNCONFIGURE_ECU                0
#define XL_KLINE_CONFIGURE_ECU                  1

////////////////////////////////////////
// event defines
// 5bdTag - subtags
#define XL_KLINE_EVT_TAG_5BD_ADDR               1
#define XL_KLINE_EVT_TAG_5BD_BAUDRATE           2
#define XL_KLINE_EVT_TAG_5BD_KB1                3
#define XL_KLINE_EVT_TAG_5BD_KB2                4
#define XL_KLINE_EVT_TAG_5BD_KB2NOT             5
#define XL_KLINE_EVT_TAG_5BD_ADDRNOT            6

// defines for the tx/rx byte error mask
#define XL_KLINE_BYTE_FRAMING_ERROR_MASK      0x1
#define XL_KLINE_BYTE_PARITY_ERROR_MASK       0x2

// defines for confirmation event
#define XL_KLINE_EVT_TAG_SET_COMM_PARAM_TESTER  1
#define XL_KLINE_EVT_TAG_COMM_PARAM_ECU         2
#define XL_KLINE_EVT_TAG_SWITCH_HIGHSPEED       3

// defines for kb2not
#define XL_KLINE_FLAG_TAKE_KB2NOT      0x80000000 

// define for addrNot
#define XL_KLINE_FLAG_TAKE_ADDRNOT     0x80000000

////////////////////////////////////////
// defines for T_KLINE_ERROR - errorType
#define XL_KLINE_ERROR_TYPE_RXTX_ERROR          1
#define XL_KLINE_ERROR_TYPE_5BD_TESTER          2
#define XL_KLINE_ERROR_TYPE_5BD_ECU             3
#define XL_KLINE_ERROR_TYPE_IBS                 4
...
#define XL_KLINE_ERR_TESTER_W1MAX               2
#define XL_KLINE_ERR_TESTER_W2MIN               3
#define XL_KLINE_ERR_TESTER_W2MAX               4
#define XL_KLINE_ERR_TESTER_W3MIN               5
#define XL_KLINE_ERR_TESTER_W3MAX               6
#define XL_KLINE_ERR_TESTER_W4MIN               7
#define XL_KLINE_ERR_TESTER_W4MAX               8

// defines for XL_KLINE_ERROR_TYPE_5BD_ECU
#define XL_KLINE_ERR_ECU_W4MIN                  1
#define XL_KLINE_ERR_ECU_W4MAX                  2

// defines for XL_KLINE_ERROR_TYPE_IBS
#define XL_KLINE_ERR_IBS_P1                     1
#define XL_KLINE_ERR_IBS_P4                     2
...
#define XL_ETH_MODE_SPEED_FIXED_1000       9    /* Set connection speed to 1 Gbps. Auto-negotiation disabled. */
...
// connector
#define XL_ETH_MODE_CONNECTOR_DONT_CARE    0    /* Apart from VN5610(A), always only one connector available anyway */
#define XL_ETH_MODE_CONNECTOR_RJ45         1    /* Using RJ-45 connector */
#define XL_ETH_MODE_CONNECTOR_DSUB         2    /* Using D-Sub connector */

// phy
#define XL_ETH_MODE_PHY_DONT_CARE          0    /* Set whatever PHY layer is available */
...
timerChannelMask. On ports created with xlOpenPort applications set timerChannelMask to zero to select all
channels of the port or specify a subset of the ports channel mask when calling
the function.
The timer rate value may be below 1ms, but is limited to the following
...
/*------------------------------------------------------------------------------
 ** xlPopupHwConfig():
 *\brief launch the Vector Hardware Config (VHwConfig, "vcanconf.exe") tool and optionally wait for it to finish.
 *  \param callSign      [IN] May be NULL. If not NULL, callSign is appended to the command line. Therefore
 *                            callSign may contain white-space separated arguments to VHwConfig.
 *  \param waitForFinish [IN] If waitForFinish it 0, xlPopupHwConfig() will immediately return. If waitForFinish is > 0,
 *                            xlPopupHwConfig will block for waitForFinish milliseconds but return earlier if the VHwConfig
 *                            child process terminates.
 *
 * Note that independently of the waitForFinish value, xlPopupHwConfig() will not force the termination of VHwConfig before
 * returning. Instead VHwConfig continues to run as a child process.
 *
 * Also note that before 11.0, xlPopupHwConfig returned XL_SUCCESS under the conditions for which it now returns XL_PENDING
 * or XL_ERR_WRONG_COMMAND.
 *
 *  \returns XL_SUCCESS           if VHwConfig was successfully launched and either waitForFinish=0 or WHwConfig exited with code 0.
 *           XL_ERROR             if an operating system error occurred. This usually means that VHwConfig failed to launch..
 *           XL_PENDING           if waitForFinish>0 and VHwConfig was successfully launched but has not exited after waitForFinish milliseconds.
 *           XL_ERR_WRONG_COMMAND if waitForFinish>0 and VHwConfig exited with a non-zero exitcode.
 * --------------------------------------------------------------------------------
*/
 ...
 *  \param accessMask      [IN] specifies the port's channel from where to get the device state
...
////////////////////////////////////////////////////////////////////////////////
DECL_STDXL_FUNC (xlKlineTransmit, XLKLINETRANSMIT,
                (DEFFRPARAM, unsigned int length, unsigned char *data));

DECL_STDXL_FUNC (xlKlineSetUartParams, XLKLINESETUARTPARAMS,
                (DEFFRPARAM, XLklineUartParameter *pxlKlineUartParams));

DECL_STDXL_FUNC (xlKlineSwitchHighspeedMode, XLKLINESWITCHHIGHSPEEDMODE,
                (DEFFRPARAM, unsigned int trxMode));

DECL_STDXL_FUNC (xlKlineSwitchTesterResistor, XLKLINESWITCHTESTERRESISTOR,
                (DEFFRPARAM, unsigned int testerR));

DECL_STDXL_FUNC (xlKlineSetBaudrate, XLKLINESETBAUDRATE,
                (DEFFRPARAM, unsigned int baudrate));
...
DECL_STDXL_FUNC (xlKlineInit5BdTester, XLKLINE5BDTESTER, 
                (DEFFRPARAM, XLkline5BdTester *pxlKline5BdTester));

DECL_STDXL_FUNC (xlKlineInit5BdEcu, XLKLINE5BDECU,
                (DEFFRPARAM, XLkline5BdEcu *pxlKline5BdEcu));
...
DECL_STDXL_FUNC (xlKlineSetCommunicationTimingEcu, XLKLINESETCOMMUNICATIONTIMINGECU,
                (DEFFRPARAM, XLklineSetComEcu *pxlKlineSetComEcu));
 ...
 *  ResponseEvent:                         
 *  \param portHandle                 [IN] handle to port from which the information is requested 
 *  \param accessMask                 [IN] specifies the port's channel from where to get the information
